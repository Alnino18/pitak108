...
// - 8   -> следующий игрок обязан положить карту СТРОГО той же масти (не по рангу) либо даму;
//          если нечем — берёт карту.
...
export function canPlay(card, topCard, activeSuit) {
  ...
  if (topCard.rank === 'Q' || topCard.rank === '8') {
    // после дамы или восьмёрки — только строго та же масть (или другая дама)
